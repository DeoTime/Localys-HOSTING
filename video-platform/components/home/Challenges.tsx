    ...
    <div className="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-900">
      <div className="flex items-start justify-between gap-3">
        <div className="flex items-center gap-2">
          ...
          <div>
            <p className="font-semibold leading-tight text-gray-900 dark:text-white">{challenge.title}</p>
...
export function Challenges() {
  return (
    <section className="grid gap-6 lg:grid-cols-2">
      <div>
        <h3 className="mb-3 text-lg font-bold text-gray-900 dark:text-white">Daily challenges</h3>
        <div className="grid gap-3">
          {dailyChallenges.map((c) => <ChallengeCard key={c.id} challenge={c} />)}
        </div>
      </div>
      <div>
        <h3 className="mb-3 text-lg font-bold text-gray-900 dark:text-white">Monthly challenges</h3>
        <div className="grid gap-3">
