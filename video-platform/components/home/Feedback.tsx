...
export function Feedback() {
  ...
  return (
    <section className="rounded-3xl border border-gray-200 bg-white p-8 text-center shadow-sm dark:border-gray-700 dark:bg-gray-900">
      ...
      <h2 className="text-xl font-bold text-gray-900 dark:text-white">We&apos;d love to hear what you think!</h2>
      <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Your feedback helps us support more local businesses.</p>
      <button
        type="button"
